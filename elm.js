...
Elm.Main.make = function (_elm) {
   ...
   var avg_waste = "Avg waste: 1447.9166666666667";
   var waste = "Total waste: 104250.0";
   var bheight = 100.0;
   var bwidth = 50.0;
   var hashColor = function (i) {
      return function () {
         var _v0 = A2($Basics._op["%"],
         i,
         9);
         switch (_v0)
         {case 0: return A4($Color.rgba,
              ...
              0,
              1);
            case 1: return A4($Color.rgba,
              0,
              255,
              0,
              1);
            case 2: return A4($Color.rgba,
              0,
              0,
              255,
              1);
            case 3: return A4($Color.rgba,
              255,
              255,
              0,
              1);
            case 4: return A4($Color.rgba,
              255,
              0,
              255,
              1);
            case 5: return A4($Color.rgba,
              0,
              255,
              255,
              1);
            case 6: return A4($Color.rgba,
              255,
              0,
              0,
              1);
            case 7: return A4($Color.rgba,
              123,
              123,
              0,
              1);
            case 8: return A4($Color.rgba,
              123,
              0,
              123,
              1);}
         return A4($Color.rgba,0,0,0,1);
      }();
   };
   var rectangle = function (_v1) {
      return function () {
         switch (_v1.ctor)
         {case "Rec":
            switch (_v1._0.ctor)
              ...
              break;}
         _U.badCase($moduleName,
         "on line 42, column 30 to 83");
      }();
   };
   var rectColor = function (_v8) {
      return function () {
         switch (_v8.ctor)
         {case "Rec":
            return hashColor($Basics.round(_v8._1 + _v8._2));}
         _U.badCase($moduleName,
         "on line 30, column 25 to 48");
      }();
   };
   var black = A4($Color.rgba,
   0,
   0,
   0,
   1);
   var pieces = function (_v13) {
      return function () {
         switch (_v13.ctor)
         {case "B":
   ...
   var showAvgWaste = A3($Graphics$Collage.collage,
   200,
   25,
   _L.fromArray([$Graphics$Collage.toForm($Graphics$Element.show(avg_waste))]));
   var showWaste = A3($Graphics$Collage.collage,
   200,
   25,
   _L.fromArray([$Graphics$Collage.toForm($Graphics$Element.show(waste))]));
   var R = function (a) {
      return {ctor: "R",_0: a};
   };
   var B = function (a) {
   ...
   var Rec = F3(function (a,b,c) {
      return {ctor: "Rec"
             ,_0: a
             ,_1: b
             ,_2: c};
   });
   var binBorder = F2(function (w,
   h) {
      return A2($Graphics$Collage.outlined,
      $Graphics$Collage.solid(black),
      rectangle(A3(Rec,
   ...
   var result = R(_L.fromArray([B(_L.fromArray([A3(Rec,
                                               {ctor: "_Tuple2"
                                               ,_0: 0.0
                                               ,_1: 0.0},
                                               30.0,
